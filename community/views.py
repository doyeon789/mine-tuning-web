...
def post_list(request):
    posts = Post.objects.select_related("author").annotate(like_total=Count("liked_users"))
...
def post_detail(request, pk):
    ...
    is_liked = request.user.is_authenticated and post.liked_users.filter(pk=request.user.pk).exists()
